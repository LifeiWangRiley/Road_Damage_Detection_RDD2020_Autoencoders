...
DETECTRON2_DATASETS = "./data"
ROADDAMAGE_DATASET  = DETECTRON2_DATASETS
        ...
        if os.path.isdir(img_path): # list annotations/xml dir and for each annotation load the data
            ...
            for run_id, img_file_idx in enumerate(img_file_idxs):
                ...
                if os.path.isfile(os.path.join(ann_fullfile)):
                    ...
                    # change for unlink error
                    # Check and unlink existing symlinks or files
                    for file_target in [ann_fullfile_target, img_fullfile_target, img_segmfile_target]:
                        if os.path.islink(file_target) or os.path.exists(file_target):
                            os.unlink(file_target)
