...
#cfg.OUTPUT_DIR            = "./run_d2_frcnn-fpn-combovt_b640_v0/"
# cfg.OUTPUT_DIR            = "./run_d2_frcnn-fpn-combovt_b640_v0_extd/"

# config for test1 best model
# cfg.OUTPUT_DIR = "./run_d2_frcnn-fpn-combovt_b640_v0_test1/"

# config for test2 best model
cfg.OUTPUT_DIR = "./run_d2_frcnn-fpn-combovt_b4096_v1_test2/"

# cfg.MODEL.DEVICE          = "cuda"
# change from cuda GPU to CPU only
